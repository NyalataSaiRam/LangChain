...
from nodes import call_llm, removeMessages
...
graph_builder.add_node('removeMessages',removeMessages)

graph_builder.add_node("tools", ToolNode(tools=tools))


graph_builder.add_edge(START, 'removeMessages')
graph_builder.add_edge('removeMessages', 'call_llm')
